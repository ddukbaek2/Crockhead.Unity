...
namespace Crockhead.Unity
{
	...
	public static class GameObjectHelper
	{
		...
		public static TComponent CreateGameObjectWithComponent<TComponent>() where TComponent : Component
		{
			...
			{
				var component = GameObjectHelper.CreateGameObjectWithComponent<TComponent>(attribute);
				return component;
			}
			else
			{
				...
				var component = GameObjectHelper.GetOrAddComponent<TComponent>(gameObject);
				return component;
			}
		}
		...
		{
			var componentType = typeof(TComponent);
			var component = GameObjectHelper.GetOrAddComponent(obj, typeof(TComponent));
			return component as TComponent;
		}
	}
}