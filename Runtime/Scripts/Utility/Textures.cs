...
namespace Crockhead.Unity
{
	...
	public static class Textures
	{
		...
		{
			var texture = Textures.CreateTexture(size, Textures.CreateEmptyTextureAsInternal, fill, Textures.CompletionTextureAsInternal);
			return texture;
		}
		/// <summary>
		/// 텍스쳐 생성.
		...
		{
			var texture = Textures.CreateTexture(size, Textures.CreateEmptyTextureAsInternal, fill, completion);
			return texture;
		}
		...
		public static Texture2D CreateTexture(int width, int height, Color color)
		{
			...
			var texture = Textures.CreateTexture(size, OnFill);
		...
		public static Texture2D CreateRoundedTexture(int width, int height, int radius, Color color)
		{
			...
			Color32 OnFill(Vector2Int position)
			{
				...
				return inside ? color : Textures.Clear;
			}
		...
		public static Texture2D CreateSmoothRoundedTexture(int width, int height, float radius, float feather, Color color)
		{
			...
			Color32 OnFill(Vector2Int position)
			{
				...
				var c = color;				
				c.a = c.a *= a;
				return c.a > 0.001f ? (Color32)c : Textures.Clear;
			}
